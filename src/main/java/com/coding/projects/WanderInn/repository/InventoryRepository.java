...
import com.coding.projects.WanderInn.dto.HotelPriceDto;
import com.coding.projects.WanderInn.dto.RoomPriceDto;
...
public interface InventoryRepository extends JpaRepository<Inventory, Long> {
    ...
    @Query("""
            SELECT new com.coding.projects.WanderInn.dto.HotelPriceDto(i.hotel, AVG(i.price))
            FROM Inventory i
           ...
           GROUP BY i.hotel
           """)
    Page<HotelPriceDto> findHotelsWithAvailableforSearchInventory(
    ...
    @Query("""
       SELECT new com.coding.projects.WanderInn.dto.RoomPriceDto(
            i.room,
            CASE
